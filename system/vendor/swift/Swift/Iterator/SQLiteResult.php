 ...
 * @author Chris Corbyn <chris@w3style.co.uk>
 */
class Swift_Iterator_SQLiteResult implements Swift_Iterator
{
  /**
   * The MySQL resource.
   * @var resource
  ...
  {
    $this->resultSet = $rs;
    $this->numRows = sqlite_num_rows($rs);
  }
  /**
   * Get the resultset.
   * @return resource
  ...
  public function next()
  {
    if ($this->hasNext())
    {
      $this->currentRow = sqlite_fetch_array($this->resultSet);
      $this->pos++;
      return true;
    }
  ...
  public function seekTo($pos)
  {
    ...
    {
      sqlite_seek($this->resultSet, $pos);
      $this->currentRow = sqlite_fetch_array($this->resultSet);
      sqlite_seek($this->resultSet, $pos);
      $this->pos = $pos;
      return true;
